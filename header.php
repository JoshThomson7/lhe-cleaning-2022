                ...
                <div class="max__width">
                    ...
                    <div class="header__main--left">
                        ...
                        <div class="logo">
                            <a href="<?php echo esc_url(home_url()); ?>" title="<?php bloginfo('name'); ?>">
                               <img src="<?php echo esc_url(get_stylesheet_directory_uri().'/img/logo.png'); ?>" alt="">
                            </a>
                        </div><!-- logo -->
                    ...
                    <div class="header__main--right">
                        ...
                        <nav class="header__actions">
                            <ul>
                                <li>
                                    <a href="<?php echo get_permalink(get_page_by_path('get-in-touch')); ?>" class="button primary medium"><span>Get in Touch</span></a>
                                </li>
                            </ul>
                        </nav><!-- header__nav -->
                    </div><!-- right -->
